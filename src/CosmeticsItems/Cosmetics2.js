...
export default function Cloth1( { product,
  brand,
  price,
  additional,
  expiry }) {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardMedia
        ...
        image="https://i.imgur.com/bBcWxA8.jpg"
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography>
            <h3>
            Product name: Eye shadow Palate <br />
Brand: James Charles <br />
Price: 1000<br />
Expiry: jan 2022<br />
Addition info: original price 2500<br />
