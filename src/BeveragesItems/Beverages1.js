...
export default function Cloth1( { brand, expiry, price, additional }) {
  ...
  return (
    <Card className={classes.root}>
      ...
      <CardMedia
        ...
        image="https://i.imgur.com/Cfv5XUs.jpg"
        title="pink top"
      />
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography>
           ...
           Price: 300 <br />
           Expiry: Mar 2021 <br />
           Additional Info: One pack little used rest two unused. <br />
              </h3>
